...
class GymManagementSystem:
    ...
    def create_widgets(self):
        title_label = ttk.Label(self.main_frame, text="Afegir socis", font=('Helvetica', 24, 'bold'))
    ...
    def submit_form(self):
        ...
        try:
            ...
            if not dni:
                cursor.execute("SELECT id FROM socis ORDER BY id DESC LIMIT 1")
            ...
            query = """
                INSERT INTO socis (dni, nom, carrer, codipostal, poblacio, provincia, email, data_naixement, telefon1, telefon2, telefon3,
                numero_conta, sepa, quantitat, alta, baixa, facial, Data_Inici_activitat, usuari, foto, activitats, data_modificacio)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            """
            values = (dni, nom, carrer, cp, poblacio, provincia, email, data_naixement, telefon1, telefon2, telefon3,
                      compte, sepa, quantitat, alta, baixa, facial, data_inici, usuari, self.photo_data, activities_str, data_modificacio)
